...
LABEL maintainer="Azintelecom <devops@azintelecom.az>"
LABEL org.opencontainers.image.title="AzCSPM Scanner"
LABEL org.opencontainers.image.description="Cloud misconfiguration detection platform for Azerbaijan's sovereign infrastructure"
LABEL org.opencontainers.image.vendor="Azintelecom"
