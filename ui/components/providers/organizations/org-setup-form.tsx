...
const orgSetupSchema = z.object({
  ...
  roleArn: z
    ...
    .regex(
      ...
      "Must be a valid IAM Role ARN (e.g., arn:aws:iam::123456789012:role/AzCSPMScanner)",
    ),
      ...
      >
        ...
        {setupPhase === ORG_SETUP_PHASE.DETAILS && (
          <div className="flex flex-col gap-4">
            ...
            <p className="text-muted-foreground text-sm">
              If left blank, AzCSPM will use the Organization name stored in
              AWS.
            </p>
          </div>
        )}
        ...
        {setupPhase === ORG_SETUP_PHASE.ACCESS && !isSubmitting && (
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-4">
              <p className="text-text-neutral-primary text-sm leading-7 font-normal">
                1) Deploy the AzCSPM Scanner role in your{" "}
            ...
            <div className="flex flex-col gap-4">
              <p className="text-text-neutral-primary text-sm leading-7 font-normal">
                2) Deploy the AzCSPM Scanner role to{" "}
            ...
            <WizardInputField
              ...
              labelPlacement="outside"
              placeholder="e.g. arn:aws:iam::123456789012:role/AzCSPMScanner"
              isRequired={false}
              requiredIndicator
            />
