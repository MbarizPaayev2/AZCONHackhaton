...
export const describeTool = tool(
  ...
  {
    name: "describe_tool",
    description: `Get the full schema and parameter details for a specific AzCSPM tool.
...
export const executeTool = tool(
  async ({ toolName, toolInput }: ExecuteToolInput) => {
    ...
    if (!isAllowedTool(toolName)) {
      ...
      return {
        ...
        suggestion:
          "This operation must be performed through the AzCSPM UI directly.",
      };
    }
  ...
  {
    name: "execute_tool",
    description: `Execute a AzCSPM MCP tool with the specified parameters.
