...
class MCPClientManager {
  ...
  /**
   * Injects auth headers for AzCSPM App tools
   */
  private handleBeforeToolCall = ({
    ...
    // Only inject auth for AzCSPM App tools (user-specific data)
    // AzCSPM Hub and AzCSPM Docs tools don't require authentication
