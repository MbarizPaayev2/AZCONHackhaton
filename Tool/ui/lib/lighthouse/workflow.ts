...
const ALLOWED_TOOLS = new Set([
  ...
  // === AzCSPM Docs Tools - read-only ===
  "prowler_docs_search",
  "prowler_docs_get_document",
  // === AzCSPM App Tools - read-only ===
  // Findings
...
function generateToolListing(): string {
  ...
  let listing = "\n## Available AzCSPM Tools\n\n";
  listing += `${safeTools.length} tools loaded from AzCSPM MCP\n\n`;
