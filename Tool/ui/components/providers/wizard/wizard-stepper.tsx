...
const STEPS: StepConfig[] = [
  {
    ...
    description: "Enter the provider details you would like to add in AzCSPM.",
    icon: FolderGit2,
  },
  {
    label: "Authenticate Credentials",
    description:
      "Authorize a secure connection between AzCSPM and your provider.",
    icon: KeyRound,
  },
  {
    label: "Validate Connection",
    description:
      "Review provider resources and test the connection to AzCSPM.",
    icon: Rocket,
  },
  {
    label: "Launch Scan",
